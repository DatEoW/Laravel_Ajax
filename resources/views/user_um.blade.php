      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer" style="justify-content: center">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="deleteNo">Không</button>
    ...
    <form action="" id="ajaxForm-lock">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer" style="justify-content: center">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="lockNo">Không</button>
    ...
    <div class="col-md-8 col-sm-12 col-xs-12">
      <form id="ajaxForm-search" style="margin-top:30px;">
        <div style="" class="form_search">
          <div class="form-group">
            <p>Tên</p>
            <input type="text" placeholder="Nhập họ tên" name="name" id="getName" class="form-control">
          </div>
          <div class="form-group">
            <p>Email</p>
            <input type="text" placeholder="Nhập Email" name="email" id="getEmail" class="form-control">
          </div>
          <div class="form-group">
            <p>Nhóm</p>
        ...
        <div style="display: flex;flex-wrap: wrap;" class="form_search">
          <div>
            <a href="javascript:void(0)" style="margin-bottom:40px !important;margin-top:40px;"
              ...
              data-role={{ Auth::user()->group_role }} data-bs-target="#addModal" class="btn btn-info mb-3 toAdd">
          ...
          <div>
            <button type="submit" id="searchBtn" class="btn btn-info mb-3"
              style="margin-bottom:40px !important;margin-top:40px;"><i class="fas fa-search" style="color: white"></i>
              Tìm kiếm</button>
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (total === 0) {
              $('#fromTo').html(null);
              $('#fromTo').append(`
                         <p style="text-align:right;"><strong>Không có sản phẩm hiển thị</strong> user</p>
                    `);
            }
